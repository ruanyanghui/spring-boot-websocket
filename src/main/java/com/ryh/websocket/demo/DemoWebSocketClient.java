...
public class DemoWebSocketClient {
    ...
    public static final String SEND_URL = GlobalConsts.APP_PREFIX + GlobalConsts.HELLO_MAPPING;//发送给服务端的 url
    ...
    public static void main(String[] args) throws Exception {
        ...
        //String url = "ws://localhost:8088" + GlobalConsts.ENDPOINT;
        String name = "spring-" + ThreadLocalRandom.current().nextInt(1, 99);
        StompSessionHandler sessionHandler = new MyStompSessionHandler(name);//这特么手动创建回话handler 访问服务端
        StompSession session = stompClient.connect(url, sessionHandler).get();//手动发消息了
